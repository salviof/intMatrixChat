 ...
 * @author salvio
 */
public class IntegracaoRestIntmatrixchatSalaExluirTest {

    public IntegracaoRestIntmatrixchatSalaExluirTest() {
    }

    /**
     * Test of gerarCorpoRequisicao method, of class
     * IntegracaoRestIntmatrixchatSalaExluir.
     */
    @Test
    public void testSomeMethod() {
        ...
        ItfRespostaWebServiceSimples resopstaAtualizacao = FabApiRestIntMatrixChatSalas.SALA_EXLUIR.getAcao(roomID).getResposta();
        System.out.println(resposta.getRespostaTexto());
